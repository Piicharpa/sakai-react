...
const Industrial = () => {
        ...
        if (product.name.trim()) {
            ...
            if (product.id) {
                ...
                toast.current?.show({
                    severity: 'success',
                    summary: 'สำเร็จ',
                    detail: 'อัพเดตข้อมูลอุตสาหกรรมแล้ว',
                    life: 3000
                });
            } else {
    ...
    const deleteSelectedProducts = () => {
        ...
        toast.current?.show({
            severity: 'success',
            summary: 'สำเร็จ',
            detail: 'ลบอุตสาหกรรมที่เลือกแล้ว',
            life: 3000
        });
    };
                ...
                <div className="card">
                    ...
                    <div className="flex justify-content-between align-items-center mb-4">
                        ...
                        <div className="flex align-items-center">
                            ...
                            <Button label="เพิ่มอุตสาหกรรม" icon="pi pi-plus" severity="success" onClick={openNew} />
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <Column field="name" header="ชื่ออุตสาหกรรม" sortable body={nameBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                    ...
                    {/* Dialog สำหรับเพิ่ม/แก้ไขอุตสาหกรรม */}
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="รายละเอียดอุตสาหกรรม" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                    ...
                    {/* Dialog ยืนยันลบอุตสาหกรรมที่เลือก */}
