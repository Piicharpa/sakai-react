...
const Register_round = () => {
    ...
    const fetchData = (tabIndex: number) => {
        ...
        switch (tabIndex) {
            case 0: // ทั้งหมด
                endpoint = '/api/Register_rounds/all';
                break;
            case 1: // รอขึ้นทะเบียน
                endpoint = '/api/Register_rounds/pending';
                break;
            case 2: // ขึ้นทะเบียน
                endpoint = '/api/Register_rounds/successful';
                break;
            default:
                endpoint = '/api/Register_rounds/all';
        }
        ...
        if (product.name.trim()) {
            ...
            if (product.id) {
                ...
                toast.current?.show({
                    severity: 'success',
                    summary: 'สำเร็จ',
                    detail: 'อัพเดตข้อมูลรอบการลงทะเบียนแล้ว',
                    life: 3000
                });
            } else {
                ...
                toast.current?.show({
                    severity: 'success',
                    summary: 'สำเร็จ',
                    detail: 'เพิ่มรอบการลงทะเบียนแล้ว',
                    life: 3000
                });
            }
    ...
    const deleteSelectedProducts = () => {
        ...
        toast.current?.show({
            severity: 'success',
            summary: 'สำเร็จ',
            detail: 'ลบรอบการลงทะเบียนที่เลือกแล้ว',
            life: 3000
        });
    };
                ...
                <div className="card">
                    ...
                    <div className="flex justify-content-between align-items-center mb-4">
                        ...
                        <div className="flex align-items-center">
                            ...
                            <Button label="เพิ่มรอบการลงทะเบียน" icon="pi pi-plus" severity="success" onClick={openNew} />
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <Column field="name" header="รอบการลงทะเบียน" sortable body={nameBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                    ...
                    {/* Dialog สำหรับเพิ่ม/แก้ไขรอบการลงทะเบียน */}
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="รายละเอียดรอบการลงทะเบียน" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                    ...
                    {/* Dialog ยืนยันลบรอบการลงทะเบียน */}
                    ...
                    {/* Dialog ยืนยันลบรอบการลงทะเบียนที่เลือก */}
